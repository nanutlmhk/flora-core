...
function mapMeasured(measured) {
  return {
    ...
    airway_resistance:        measured.airway_resistance,
    tidal_volume_exp_spont:   measured.tidal_volume_exp_spont,
    tidal_volume_insp:        measured.tidal_volume_insp,
    minute_volume_insp:       measured.minute_volume_insp,
    ...
    fi_agent_2nd:         measured.fi_agent_2nd,
    et_agent_2nd:         measured.et_agent_2nd,
    agent_id_2nd:         measured.agent_id_2nd,
    fi_n2o:               measured.fi_n2o,
    et_n2o:               measured.et_n2o,
    mac:                  measured.mac,
    rr_co2:               measured.rr_co2,

    // Gas supply pressures
    pressure_o2_supply:   measured.pressure_o2_supply,
    pressure_n2o_supply:  measured.pressure_n2o_supply,
    pressure_air_supply:  measured.pressure_air_supply,
    ...
    t_insp_meas:          measured.t_insp_meas,
    t_exp_meas:           measured.t_exp_meas,
  };
}
...
function mapSettings(settings) {
  return {
    ...
    tpause_set:     settings.tpause_set,
